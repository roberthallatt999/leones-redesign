...
use Low\Search\FluxCapacitor\Base\Upd;
use Low\Search\FluxCapacitor\Conduit\Version;
 ...
 */
class Low_search_upd extends Upd
{
    // Use the base trait
    use Low_search_base;
    ...
    /**
     * Update routines for version 7.0.0
     *
     * @access     private
     * @return     void
     */
    private function _v700()
    {
        $data = array(
            'site_id'     => $this->site_id,
            'addon'       => 'Low\Search',
            'license_key' => ee()->low_search_settings->get('license_key')
        );
        $version = new Version();
