...
/**
 * EEHarbor PHAR Loader for Low Search
 ...
 * @link       https://eeharbor.com/low_search
 */

spl_autoload_register(
    function ($class_name) {
        // This is the PHAR path for this addon
        $phar_path = PATH_THIRD . 'low_search/low_search.phar';
        $phar_stream_path = 'phar://' . $phar_path;
        $tmp_phar_path = sys_get_temp_dir() . '/pharextract/low_search';
