...
/**
 * EEHarbor PHAR Loader for Low Reorder
 ...
 * @link       https://eeharbor.com/low_reorder
 */

spl_autoload_register(
    function ($class_name) {
        // This is the PHAR path for this addon
        $phar_path = PATH_THIRD . 'low_reorder/low_reorder.phar';
        $phar_stream_path = 'phar://' . $phar_path;
        $tmp_phar_path = sys_get_temp_dir() . '/pharextract/low_reorder';

        $namespace = 'Low\Reorder';
