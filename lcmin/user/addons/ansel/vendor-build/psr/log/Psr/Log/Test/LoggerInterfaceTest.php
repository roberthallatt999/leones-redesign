...
namespace BoldMinded\Ansel\Dependency\Psr\Log\Test;

use BoldMinded\Ansel\Dependency\Psr\Log\LoggerInterface;
use BoldMinded\Ansel\Dependency\Psr\Log\LogLevel;
...
abstract class LoggerInterfaceTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('BoldMinded\\Ansel\\Dependency\\Psr\\Log\\LoggerInterface', $this->getLogger());
    }
    /**
    ...
    public function testObjectCastToString()
    {
        if (\method_exists($this, 'createPartialMock')) {
            $dummy = $this->createPartialMock('BoldMinded\\Ansel\\Dependency\\Psr\\Log\\Test\\DummyTest', array('__toString'));
        } else {
            $dummy = $this->getMock('BoldMinded\\Ansel\\Dependency\\Psr\\Log\\Test\\DummyTest', array('__toString'));
        }
