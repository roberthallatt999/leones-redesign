...
use BoldMinded\Ansel\Dependency\Bamarni\Composer\Bin\CommandProvider as BamarniCommandProvider;
use BoldMinded\Ansel\Dependency\Bamarni\Composer\Bin\Config\Config;
use BoldMinded\Ansel\Dependency\Bamarni\Composer\Bin\Input\BinInputFactory;
use BoldMinded\Ansel\Dependency\Composer\Composer;
use BoldMinded\Ansel\Dependency\Composer\Console\Application;
use BoldMinded\Ansel\Dependency\Composer\EventDispatcher\EventSubscriberInterface;
use BoldMinded\Ansel\Dependency\Composer\IO\ConsoleIO;
use BoldMinded\Ansel\Dependency\Composer\IO\IOInterface;
use BoldMinded\Ansel\Dependency\Composer\Plugin\CommandEvent;
use BoldMinded\Ansel\Dependency\Composer\Plugin\PluginEvents;
use BoldMinded\Ansel\Dependency\Composer\Plugin\PluginInterface;
use BoldMinded\Ansel\Dependency\Composer\Plugin\Capable;
use BoldMinded\Ansel\Dependency\Composer\Script\Event;
use BoldMinded\Ansel\Dependency\Composer\Script\ScriptEvents;
use BoldMinded\Ansel\Dependency\Symfony\Component\Console\Command\Command;
use BoldMinded\Ansel\Dependency\Composer\Plugin\Capability\CommandProvider as ComposerPluginCommandProvider;
use BoldMinded\Ansel\Dependency\Symfony\Component\Console\Input\InputInterface;
use BoldMinded\Ansel\Dependency\Symfony\Component\Console\Output\OutputInterface;
use Throwable;
use function count;
